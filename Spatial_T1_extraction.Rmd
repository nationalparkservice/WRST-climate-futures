...
scatterplot(df=Deltas,X=JJA_Precip_in,Y=water_balance,title="Summer precip vs water balance scatterplot",xaxis="Avg JJA Precip (in)",yaxis="Avg Annual Water Balance (in)")
