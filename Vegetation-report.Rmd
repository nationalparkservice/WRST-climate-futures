...
![Geographic areas in WRST used for climate analysis](Data/figures/WRST_area_map.png){width="431"}
...
![Figure 2. Seasonal change in TmaxF](Data/figures/Scatterplot-TvsP.png)
...
![Table 2. Vegetation climate sensitivities](Data/figures/Veg-metrics-table.png "Vegetation climate sensitivities")
...
![Figure XX. Seasonal change in TmaxF](Data/figures/seasonal_tmaxF.png)
![Figure XX. Seasonal change in TminF](Data/figures/seasonal_tminF.png)

![Figure XX. Seasonal change in Pcp](Data/figures/seasonal_precipIn.png)
![Figure XX. Annual tmean](Data/figures/Annual.tmeanF_ANN.png)

![Figure XX. Annual precip](Data/figures/Annual.precipIn_ANN.png)
![Figure XX. Annual water balance (precip-ET)](Data/figures/water.balance_ANN.png)

### Threshold metrics

The following plots represent annual averages for threshold exceedance metrics in different regions of WRST (see Figure 1).
![Figure XX. wrst_mtns threshold exceedance](Data/figures/wrst_mtns_ts-stack.png)
![Figure XX. wrst_mtns threshold exceedance](Data/figures/copper_plateau_ts-stack.png)
![Figure XX. wrst_mtns threshold exceedance](Data/figures/coastal_mtns_ts-stack.png)
![Figure XX. wrst_mtns threshold exceedance](Data/figures/eastern_coast_ts-stack.png)

### Snow metrics
![Figure XX. Annual water balance (precip-ET)](Data/figures/SWE.precip_ANN.png)
![Figure XX. Annual water balance (precip-ET)](Data/figures/max.SWE_ANN.png)
![Figure XX. Annual water balance (precip-ET)](Data/figures/MAMSON.SWE_ANN.png)
![Figure XX. Soil temperature](Data/figures/wrst_mtns_SWE-runoff.png)
![Figure XX. Soil temperature](Data/figures/copper_plateau_SWE-runoff.png)
![Figure XX. Soil temperature](Data/figures/coastal_mtns_SWE-runoff.png)
![Figure XX. Soil temperature](Data/figures/eastern_coast_SWE-runoff.png)

### Soils and permafrost metrics
![Figure XX. Soil temperature](Data/figures/soil.temp_ANN.png)
