...
![Geographic areas in WRST used for climate analysis](images/WRST_area_map.png){width="431"}
...
```{r general climate metrics, echo=FALSE, message=FALSE, warning=FALSE,eval=FALSE}
source(here::here("Code", "Plots", "xxx.R"),echo = FALSE) 
```
