...
Something to note is that I filtered the variable of interest (tmax, here) before creating the stars object. If the variable was not specified, stars would create an object with as many attributes as variables contained in the data (e.g., tmax + tmin + precip = 3). I parceled tmax out in the interest of saving computing power when creating large stars objects, but if you are dealing with fewer years or substantial computing power, it's probably better to go through this process once and then `dplyr::select()` variables
