...
First, load the park shapefile. I saved this as a .Rds file so it could be easily accessed from GitHub for this tutorial. It was created using `sf::st_read()`. Sf and stars play nicely together, as they were created by the same person. 
